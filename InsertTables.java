...
public class InsertTables extends JFrame {
	...
	/**
	 * Create the insert tables frame.
	 */
	public InsertTables() {
		setTitle("Insert Tables");
		...
		btnSubmit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				String cmd = "INSERT INTO tables(tablename, tabledescription) VALUES(?, ?)";
				try (PreparedStatement pst = Home.con.prepareStatement(cmd)) {
					...
					e.printStackTrace();
					JOptionPane.showMessageDialog(null, "An error occured when inserting the table.");
				}
			}
		});
