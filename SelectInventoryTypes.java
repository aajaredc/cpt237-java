...
public class SelectInventoryTypes extends JFrame {
	 ...
	 * SELECT employees
	 */
	public SelectInventoryTypes() {
		setTitle("Select InventoryTypes");
	...
	private void refreshTable(String keywords) {
		cmd = "SELECT * FROM inventorytypes "
				+ "WHERE inventorytypekey LIKE ? OR inventorytypename LIKE ? "
				+ "OR inventorytypedesc LIKE ? "
				+ "ORDER BY inventorytypekey ASC";
