	...
	public InsertMenuItem() {
		...
		btnSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				cmd = "INSERT INTO menuitem(menuitemname, menutypekey, menuitemprice, "
						+ "menuitemavailable, menuitemsize, menuitemcomment) "
						+ "VALUES(?, ?, ?, ?, ?, ?)";
