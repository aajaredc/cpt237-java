...
public class SelectMenuTypes extends JFrame {
	 ...
	 * SELECT employees
	 */
	public SelectMenuTypes() {
		setTitle("Select Menu Types");
	...
	private void refreshTable(String keywords) {
		cmd = "SELECT * FROM menutypes "
				+ "WHERE menutypekey LIKE ? OR menutypename LIKE ? "
				+ "OR menutypecomment LIKE ? "
				+ "ORDER BY menutypekey ASC";
