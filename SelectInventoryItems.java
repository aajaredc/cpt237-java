...
public class SelectInventoryItems extends JFrame {
	 ...
	 * SELECT employees
	 */
	public SelectInventoryItems() {
		setTitle("Select InventoryItems");
	...
	private void refreshTable(String keywords) {
		cmd = "SELECT inventoryitemname, inventorytypename, inventoryitemquantity, inventoryitemdesc "
				+ "FROM inventoryitem "
				+ "INNER JOIN inventorytypes ON inventoryitem.inventorytypekey = inventorytypes.inventorytypekey "
				+ "WHERE inventoryitemkey LIKE ? OR inventoryitemname LIKE ? "
				+ "OR inventorytypename LIKE ? OR inventoryitemquantity LIKE ? "
				+ "OR inventoryitemdesc LIKE ?"
				+ "ORDER BY inventoryitemkey ASC";
